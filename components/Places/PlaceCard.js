...
import BirdsDataSource from './BirdsDataSource';

const filteredData = BirdsDataSource;
...
const PropertyList = () => {
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity style={styles.card} onPress={birdPressed.bind(this, item.category)}>
      <Image source={{ uri: "https://sebi.io/demo-image-api/" + item.path }} style={styles.image} />
